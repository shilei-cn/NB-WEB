...
import * as deviceType from './modules/device-type'
import * as deviceTrusted from './modules/device-trusted'
import * as merchantList from './modules/merchant-mgr-list'
import * as merchantDetail from './modules/merchant-mgr-detail'
...
fnCreate(deviceType, false)
fnCreate(deviceTrusted, false)
fnCreate(merchantList, false)
fnCreate(merchantDetail, false)
