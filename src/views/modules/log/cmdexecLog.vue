	...
	<el-row>
						...
						<el-table
							...
							<el-table-column
									...
									prop="cmdData" >
									<template slot-scope="scope">
									<el-button @click="handleClick(scope.row)" size="small" type="text">指令详情</el-button>
									</template>
							</el-table-column>
							<el-table-column									
									label="指令响应数据"
									>
									<template slot-scope="scope">
									<el-button @click="handleResultClick(scope.row)" size="small" type="text">指令响应数据详情</el-button>
									</template>
							</el-table-column>
							<el-table-column
									label="执行结果"
						...
						<el-form ref="form" :model="form" label-width="120px">
							<el-form-item label="执行指令详情" prop="name">
								<pre><span v-html="this.cmdDataString"></span></pre>
							</el-form-item>
						</el-form>
						</el-dialog>
						<el-dialog
							...
							center>
						<el-form ref="form" :model="form" label-width="120px">
							<el-form-item label="指令响应数据" prop="name">
								<pre><span v-html="this.resultDataString"></span></pre>
							</el-form-item>
						</el-form>
						</el-dialog>
	</el-row>
...
export default {
	...
	methods: {
			...
			handleClick(val) {
					this.form = val;
					this.cmdDataString = val.cmdData;                
					this.centerDialogVisible = true;
				},
			handleResultClick(val) {
					this.form = val;
					this.resultDataString = val.returnData;                
					this.resultDialogVisible = true;
				},
		   reloadPageList: function () {			
                this.pageLoading = true;
                this.$http({
					  url: this.$http.adornUrl('/cmdexecLog/list'),
					  method: 'post',
