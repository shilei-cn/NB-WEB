						...
						<el-table
							...
							<el-table-column
								...
								<template slot-scope="scope">
									<span v-if="scope.row.diffType == '01' ">无提现</span>
									<span v-if="scope.row.diffType == '02' ">无消费</span>
									<span v-if="scope.row.diffType == '03' ">金额不一致</span>
								</template>
							</el-table-column>
							<el-table-column									
									label="中心流水号"
...
export default {
	...
	methods: {
		   ...
		   reloadPageList: function () {			
                ...
                this.$http({
					  url: this.$http.adornUrl('/web/varianceList'),
					  method: 'post',
